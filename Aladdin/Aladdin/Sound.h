...
#define GAME1_MUSIC "sound\\Sultan's Dungeon.wav"
#define GAME2_MUSIC "sound\\bosstheme.wav"
#define ALADDIN_CUT_MUSIC "sound\\Low Sword.wav"
#define GUARD_CUT_MUSIC "sound\\High Sword.wav"
#define THROW_MUSIC "sound\\Apple Splat.wav"
#define ALADDIN_HURT_MUSIC "sound\\Aladdin Hurt.wav"
#define NORMALGUARD_HURT_MUSIC "sound\\Guard Hit 1.wav"
#define THINGUARD_HURT_MUSIC "sound\\Guard Hit 2.wav"
#define APPLE_MUSIC "sound\\Apple Collect.wav"
#define APPLE_POP_MUSIC "sound\\Balloon Pop.wav"
#define RUBY_MUSIC "sound\\Gem Collect.wav"
#define BLUEHEART_MUSIC "sound\\Extra Health.wav"
#define PEDDLERSTALL_MUSIC "sound\\Peddler Shop (DAC only).wav"
#define OKSTALL_MUSIC "sound\\Cash Register.wav"
#define STONEBRICK_MUSIC "sound\\Stone Rumble.wav"
#define SHARPTRAP_MUSIC "sound\\Pom Poms (Prototype).wav"
...
#define BOOMSKELETON_MUSIC "sound\\Skeleton (DAC Only).wav"
