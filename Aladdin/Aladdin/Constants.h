...
#define MAP_EDGE_LEFT 10
#define MAP_EDGE_RIGHT 2270
...
// Aladdin
#define ALADDIN_SPEED_RUN 0.2f
#define ALADDIN_SPEED_RUNNEXT 0.1f
#define ALADDIN_SPEED_FLY_VX 0.08f
#define ALADDIN_SPEED_FLY_VY 0.04f
#define ALADDIN_SPEED_FALL 0.015f
#define ALADDIN_SPEED_CLIMB 0.08f
#define ALADDIN_SPEED_WHENJUMP 0.14f
#define ALADDIN_SPEED_BRAKE 0.05f
#define ALADDIN_SPEED_JUMP 0.4f
#define ALADDIN_SPEED_JUMPCLIMB 0.33f
#define ALADDIN_SPEED_JUMPRUN 0.35f

#define ALADDIN_POTISION_X 120
#define ALADDIN_POTISION_Y 1100
#define ALADDIN_POTISION_X_INIT 120
#define ALADDIN_POTISION_Y_INIT 1100

#define ALADDIN_HURT 1

#define ALADDIN_BLOOD 8
#define ALADDIN_LIFE 3
#define ALADDIN_APPLE 10
#define ALADDIN_RUBY 11
#define ALADDIN_SCORE 0
#define ALADDIN_TIME_BLINK 1200

// Abu
#define ABU_SPEED_RUN 0.1f

// Apple
#define APPLE_SPEED_THROW_VX 0.35f
#define APPLE_SPEED_THROW_VY 0.1f
#define APPLE_SPEED_THROWCLIMB_VX 0.35f
#define APPLE_SPEED_THROWCLIMB_VY 0.07f
#define APPLE_SPEED_FALL 0.2f